          ...
          <div class="widget">
            ...
            <div class="widget-content">
              <ul class="messages_layout">
                <li class="from_user left"> <a href="#" class="avatar"><img src="${app_path }/assets_3/img/message_avatar1.png"/></a>
                ...
                <li class="by_myself right"> <a href="#" class="avatar"><img src="${app_path }/assets_3/img/message_avatar2.png"/></a>
                  <div class="message_wrap"> <span class="arrow"></span>
                ...
                <li class="from_user left"> <a href="#" class="avatar"><img src="${app_path }/assets_3/img/message_avatar2.png"/></a>
                  <div class="message_wrap"> <span class="arrow"></span>
            ...
            <div class="widget-content">
              <ul class="news-items">
                ...
                <li>
                  ...
                  <div class="news-item-detail"> <a href="http://www.by EGrappler/retina-ready-responsive-app-landing-page-website-template-app-landing/" class="news-item-title" target="_blank">Retina Ready Responsive App Landing Page Website Template â App Landing</a>
